#Extracts Richness, Diversity, and other measures from Summary.single at the Genus level
import os
...
csv_writer = csv.writer(open("c:\Sync Folder\Biorg\Python\Richness_And_Diversity_Table_Genus.csv", "wt"))
